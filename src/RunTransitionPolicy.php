...
final class RunTransitionPolicy
{
    ...
    public static function allowedFrom(RunStatus $status): array
    {
        return match ($status) {
            ...
            RunStatus::Preparing => [RunStatus::Running, RunStatus::NeedsInput, RunStatus::Failed, RunStatus::TimedOut, RunStatus::Cancelled],
            RunStatus::Running => [RunStatus::NeedsInput, RunStatus::Succeeded, RunStatus::Failed, RunStatus::TimedOut, RunStatus::Cancelled],
